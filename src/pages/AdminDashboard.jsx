...
function AdminDashboard() {
    ...
    return (
        // ✅ Fix 1: tambah paddingLeft, paddingRight, boxSizing
        <div style={{ maxWidth: '1200px', margin: '0 auto', width: '100%', paddingBottom: '3rem', paddingLeft: '1rem', paddingRight: '1rem', boxSizing: 'border-box' }}>
            ...
            <div style={{ background: 'linear-gradient(135deg, #1e1b4b 0%, #4338ca 100%)', padding: 'clamp(2rem, 5vw, 3.5rem) clamp(1.5rem, 4vw, 3rem)', borderRadius: '24px', boxShadow: '0 10px 20px rgba(67, 56, 202, 0.25)', marginBottom: '3rem', color: 'white' }}>
                <h2 style={{ margin: '0 0 0.5rem 0', fontSize: 'clamp(1.5rem, 4vw, 2.5rem)', fontWeight: '800' }}>Overview Sistem Terpusat</h2>
            ...
            {isLoading ? (
                ...
                <div style={{ display: 'flex', flexDirection: 'column', gap: '3rem' }}>
                    <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(200px, 1fr))', gap: '1.5rem' }}>
                        <div className="stat-card" style={{ backgroundColor: '#ffffff', padding: '2rem', borderRadius: '20px', borderTop: '6px solid #2563eb' }}>
                        ...
                        <div className="stat-card" style={{ backgroundColor: '#ffffff', padding: '2rem', borderRadius: '20px', borderTop: '6px solid #059669' }}>
                        ...
                        <div className="stat-card" style={{ backgroundColor: '#ffffff', padding: '2rem', borderRadius: '20px', borderTop: '6px solid #d97706' }}>
                        ...
                        <div className="stat-card" style={{ backgroundColor: '#ffffff', padding: '2rem', borderRadius: '20px', borderTop: '6px solid #7c3aed' }}>
                    ...
                    {/* ✅ Fix 2: padding pakai clamp */}
                    <div style={{ backgroundColor: '#ffffff', padding: 'clamp(1.5rem, 4vw, 3rem)', borderRadius: '24px', border: '1px solid #f1f5f9' }}>
                        ...
                        {/* ✅ Fix 3: flexWrap agar form wrap di mobile */}
                        <form onSubmit={handleAddCategory} style={{ display: 'flex', gap: '1rem', flexWrap: 'wrap' }}>
                            <input
                                ...
                                required
                                style={{ flex: 1, minWidth: '200px', padding: '1rem 1.5rem', borderRadius: '12px', border: '1px solid #e2e8f0', fontSize: '1.05rem', outline: 'none', backgroundColor: '#f8fafc' }}
                            />
                            <button
                                type="submit"
                                style={{ backgroundColor: '#1e1b4b', color: 'white', border: 'none', padding: '0 2rem', borderRadius: '12px', cursor: 'pointer', fontWeight: '700', fontSize: '1.05rem', whiteSpace: 'nowrap' }}
                            >
                                Simpan Master
                            </button>
                        </form>
                    ...
                    {/* ✅ Fix 4: overflowX pada wrapper tabel */}
                    <div style={{ backgroundColor: '#ffffff', padding: 'clamp(1.5rem, 4vw, 3rem)', borderRadius: '24px', border: '1px solid #f1f5f9' }}>
